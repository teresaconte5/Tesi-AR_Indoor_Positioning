...
class MqttHandler(val topicId: String) {
    ...
    companion object {
        ...
        const val CLIENT_USER_NAME = "<user-name>"  //imposto io
        const val CLIENT_PASSWORD = "<password>"   //imposto io per il broker MQTT
    ...
    fun setMqttCallBackAndConnect() {
        ...
        client.setCallback(object : MqttCallbackExtended {
            ...
            override fun messageArrived(topic: String?, message: MqttMessage?) {
                ...
                val payload = message?.payload?.toString(Charsets.UTF_8)  // estratto il payload del messaggio per ulteriori elaborazioni
