    ...
    el.addEventListener("gps-camera-update-position", async(e) => {
        if(!downloaded) {
            ...
            pois.features.forEach ( feature => {
                ...
                compoundEntity.setAttribute("scale", {
                    x: 0.5,
                    y: 0.5,
                    z: 0.5
                });

                compoundEntity.setAttribute('animation', "property: rotation; to: 0 360 10" );
                compoundEntity.setAttribute('gltf-model', './Assets/dragonite/scene.gltf' );
